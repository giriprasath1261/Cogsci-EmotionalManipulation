class Scene3 extends Phaser.Scene {
  ...
  create() {
    ...
    var bet = prompt(" You have 10 points how much do you want to bet cancel if you want to bet 1 point", "1");
    if(bet > 10) {
      bet = prompt(" Please enter a bet within 1-10 points");
    }
    if(bet<=10 && bet>=1) {
      localStorage.setItem("sadbet", bet);
      console.log(bet);
    }
    ...
    yesButton.on('pointerdown', () => {
      ...
      if(this.curIndex>=2) {
        ...
        noButton.on('pointerdown', ()=> {
          ...
          // console.log(risks);
          alert("YOU CHOSE TO STAY AND NOT PICK A CARD, \n The opponent only has 12 and you have 16 you win :) \n move to next round");
          this.scene.start("Scenevid2");
        })
      }
      ...
      if(this.score>=21) {
        ...
        // console.log(risks);
        alert("YOU CHOSE TO PICK A CARD AND YOUR IS NOW 19 \n opponent exceeded 21 you scored 19 you win :) \n move to next round");
        this.scene.start("Scenevid2");
      }
    });
  }
