      ...
      yesButton.on('pointerdown', () => {
        ...
        if(this.curIndex>=2) {
          ...
          noButton.on('pointerdown', ()=> {
            var risks = localStorage.getItem("timerRisks");
            risks = risks + 0;
            localStorage.setItem("timerRisks", risks);
            console.log(risks);
            alert("The opponent scored only 12 you win :) \n move to next round");
        ...
        if(this.score>=21) {
            ...
            localStorage.setItem("timerRisks", risks);
            console.log(risks);
            alert("the opponent exceeded 21 you win :) \n move to next round");
            this.scene.start("playGame6");
        }
      });
    }
