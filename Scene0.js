class Scene0 extends Phaser.Scene {
  ...
  create() {
    ...
    this.ScoreGot = this.add.bitmapText(10, 20, "pixelFont", "Score:  " + this.score.toString() , 40);
    ...
    var bet = prompt(" PLACE YOUR BET !!!!!! \n You have 10 points how much do you want to bet cancel if you want to bet 1 point", "1");
    if(bet > 10) {
      bet = prompt(" PLACE YOUR BET !!!!! \n Please enter a bet within 1-10 points");
    }
    if(bet<=10 && bet>=1) {
      localStorage.setItem("normalbet", bet);
      console.log(bet);
    }
    ...
    yesButton.on('pointerdown', () => {
      ...
      if(this.curIndex>=2) {
        ...
        noButton.on('pointerdown', ()=> {
          ...
          // console.log(risks);
          alert("YOU CHOSE TO STAY AND NOT PICK A CARD, \n The opponent only has 14 and you have 16 you win :) \n move to next round");
          this.scene.start("Scenevid1");
        })
      }
      
      // var check = localStorage.getItem("sadbet");
      // console.log(check);
      ...
      if(this.score>=21) {
        ...
        // console.log(risks);
        alert("YOU CHOSE TO PICK A CARD AND YOUR IS NOW 20 \n opponent exceeded 21 you scored 20 you win :) \n move to next round");
        this.scene.start("Scenevid1");
      }
    });
  }
