class Scene4 extends Phaser.Scene {
    ...
    create() {
      ...
      if(bet<=10 && bet>=1) {
        localStorage.setItem("happybet", bet);
      }
      ...
      yesButton.on('pointerdown', () => {
        ...
        if(this.curIndex>=2) {
          ...
          noButton.on('pointerdown', ()=> {
            ...
            console.log(risks);
            alert("YOU CHOSE TO STAY AND NOT PICK A CARD, \n The opponent has scored 19 and you have only 15 you LOSE :( \n move to next round");
            this.scene.start("Scenevid3");
          })
        }
        ...
        if(this.score>=21) {
            ...
            localStorage.setItem("risks", risks);
            console.log(risks);
            alert("YOU CHOSE TO PICK A CARD AND YOUR SCORE IS NOW 23 \n you exceeded 21 you lose :( \n move to next round");
            this.scene.start("Scenevid3");
        }
      });
    }
