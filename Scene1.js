class Scene1 extends Phaser.Scene {
    ...
    preload(){
      ...
      this.load.video("vid1", "assets/videos/vid1.mp4", 'loadeddata', false, false);
      this.load.video("vid2", "assets/videos/vid2.mp4", 'loadeddata', false, false);
      this.load.video("vid3", "assets/videos/vid3.mp4", 'loadeddata', false, false);
      this.load.video("vid4", "assets/videos/vid4.mp4", 'loadeddata', false, false);
    ...
    create() {
      ...
      var text3 = this.add.text(150, 265, " View a short video and after that you can place your bet in the pop-up, you have 10 points in the start of each round ", style3)
      var text4 = this.add.text(150, 380, " You lose your bet if you lose the round and get double the points if you win, the remaining points get stored every round and at the end the sum of the remaining points in the final score ", style3)
      
      var nextButton = this.add.sprite(200, 540, 'nextButton').setInteractive();
